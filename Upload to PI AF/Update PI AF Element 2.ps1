param($PIAFPath,$DisplayImagePath1,$DisplayImagePath2,$BooleanEnviar)
...
If (!$PIAFPath.Equals("") -and !$DisplayImagePath1.Equals("") -and !$DisplayImagePath2.Equals("") -and !$BooleanEnviar.Equals("")){
